...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = festFirebaseUserStream()
      ..listen((user) {
...
class _NavBarPageState extends State<NavBarPage> {
  ...
  Widget build(BuildContext context) {
    final tabs = {
      ...
      'QuizzHome': const QuizzHomeWidget(),
      'Assessment': const AssessmentWidget(),
        ...
        items: [
          ...
          FloatingNavbarItem(
            customWidget: Column(
              ...
              children: [
                Icon(
                  currentIndex == 1 ? Icons.quiz_rounded : Icons.quiz_outlined,
